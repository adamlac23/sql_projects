/*
Purpose: Top N customers by revenue and profit margin.
Tables: Orders(... CustomerID, Quantity, UnitPrice, Discount, ShippingCost), Customers(CustomerID, CustomerName)
*/
WITH cust AS (
  SELECT
      O.CustomerID,
